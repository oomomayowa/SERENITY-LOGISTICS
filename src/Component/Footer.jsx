      ...
      <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            ...
            <ul className="text-white dark:text-white font-medium">
                <li className="mb-4">
                    <a href="#" className=" hover:underline">We are the #MOVEMENT People Your Trusted Logistics Aggregator</a>
                </li>
        ...
        <div>
            ...
            <ul className="text-white dark:text-white font-medium">
                ...
                <li className="mb-4">
                    <a href="#" className="hover:underline">Become an agent</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-white dark:text-white font-medium">
                <li className="mb-4">
                    <a href="#" className="hover:underline">+2348085546073</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">support@visco.com.ng</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Polystar 2nd Roundabout, Lekki Phase 1 105102, Lagos</a>
                </li>
                <li className="mb-4">
