  ...
  return (
    <>
      <div className="flex justify-center bg-green-500">
        <div className='  className="block max-w-[18rem] rounded-lg bg-white text-left shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 m-2'>
          <h1 className="px-8 p-4 text-4*1 flex item-center justify-center py-4 rounded-md text-pink-500 font-bold font-weight: 700 text-xl font-size: 9.25rem;">
            {Number}
          </h1>
          <small className="px-8 p-4 text-4*1 flex item-center justify-center py-4 rounded-md">
            CREATED ORDER
          </small>
        </div>
        <div className='  className="block max-w-[18rem] rounded-lg bg-white text-left shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 m-2'>
          <h1 className="px-8 p-4 text-4*1 flex item-center justify-center py-4 rounded-md text-yellow-500 font-bold font-weight: 700 text-xl font-size: 9.25rem;">
            {Number}
          </h1>
          <small className="px-8 p-4 text-4*1 flex item-center justify-center py-4 rounded-md">
            ACCEPTED ORDER
        ...
        <div className='  className="block max-w-[18rem] rounded-lg bg-white text-left shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 m-2'>
          <h1 className="px-8 p-4 text-4*1 flex item-center justify-center py-4 rounded-md text-orange-500 font-bold font-weight: 700 text-xl font-size: 9.25rem;">
            0
          </h1>
          <small className="px-8 p-4 text-4*1 flex item-center justify-center py-4 rounded-md">
            {" "}
                  ...
                  <div className="w-full lg:w-6/12 px-4">
                    <div className="relative w-full mb-3">
                      ...
                      <input
                        type="text"
                        className="border-0 px-3 py-3 placeholder-green-300 text-green-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                        placeholder="bicycle,bike,car,truck,"
                  ...
                  <div className="w-full lg:w-12/12 px-4">
                    <div className="relative w-full mb-3">
                      ...
                      <input
                        type="text"
                        className="border-0 px-3 py-3 placeholder-green-300 text-green-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                        placeholder="Bld Mihail Kogalniceanu"
                  ...
                  <div className="w-full lg:w-12/12 px-4">
                    <div className="relative w-full mb-3">
                      ...
                      <input
                        type="text"
                        className="border-0 px-3 py-3 placeholder-green-300 text-green-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                        placeholder="city(within same state or city),  inter-state,  inter-country"
