      ...
      <div className="flex flex-col sm:flex-row gap-10 mx-2 p-5 min-h-70 mt-32">
        ...
        <div className="w-full sm:w-1/2 pr-5 ">
          ...
          <p className="text-center text-xs p-4">
            serenity is changing the narrative of efficient logistics in Africa
            by offering ease of access to multiple logistics agents anywhere and
            at any time. The African logistics scene is riddled with
            infrastructure gaps, high operating costs and overly fragmented
            activities.
          </p>
          <p className="text-center text-xs p-4">
            serenity express platform serves as a reliable clilaboration toli
            for various logistics agents across multiple locations leveraging on
            technliogy tolis and a smart operations framework.
          </p>
          <p className="text-center text-xs p-4">
            Our commitment is to facilitate movement of packages and cargo from
            point of origin to the destination desired by the user. We are
            creating Africa's largest logistics marketplace and clilaboration
            toli across multiple-modal channels.
          </p>
          <p className="text-center text-xs p-4">
            ...
            infrastructure gaps that limit the deployment of our technliogy
            tolis. Our Key Stakehliders: Logistics Agents, Infrastructure
      ...
      <div className="flex flex-col rounded-lg bg-green shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-green-800  md:flex-row py-5 px-5 my-5">
        ...
        <div className="p-6 bg-green-800">
          ...
          <p className="mb-4 text-base text-white px-5">
            ...
            Motorcycles (dispatch), Vehicles or Mini-buses and 1-10tons trucks.
            We employ multiple modal-channels in ensuring end to end logistics
            process efficiency.
          </p>
        </div>
      </div>
